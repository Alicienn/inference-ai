...
*Version 28 — trois défauts corrigés, trois architectures, une loi quantitative, et une structure d'attention vérifiée*
...
## Le banc de récupération existe : GPT-2
...
### La rétention du pic est une fausse piste (auto-correction)
...
`20_sortie_attention/code/` : `courbe_corrigee.py`, `remesure_qwen.py`, `echelle_corrigee.py`, `transfert_domaines.py`, `base_figee.py`, `index_appris_v2.py`, `audit_causal_base.py`, `balayage_Lb_m.py`, `balayage_budget_constant.py`, `balayage_fenetre.py`, `frontiere_budget.py`, `gpt2_generalite.py`, `echelle_saturee.py`, `mecanisme_trou.py`, `mecanisme_corrige.py`, `invariance_kappa.py`, `plancher_uniforme.py`, `decomposition_distante.py`, `sink_verif.py`, `grille_sink.py`, `profil_fin.py`, `kappa_T_propre.py`, `index_vs_oracle.py`, `fraction_lue.py`, `retention_aiguille.py`, `induction_span.py`, `induction_span_qwen.py`, `induction_span_gpt2.py`, `gpt2_pic_bloc.py`, `gpt2_pic_balayage.py`, `gpt2_agregation.py`, `gpt2_masse_pic.py`, `gpt2_metrique.py`, `verification_v2.py`, `verification_qwen.py`, `diag_verif.py`. Sorties dans `resultats/`.
