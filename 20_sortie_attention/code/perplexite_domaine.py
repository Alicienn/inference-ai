# -*- coding: utf-8 -*-
"""Le motif 'la selection informee NUIT' tient-il sur du texte EN DOMAINE (wikitext) ?
SmolLM2-135M, T=1024, W=256, Lb=64, m=4, texte = wikitext (cache). Harnais valide."""
...
log = OUT / "perplexite_domaine.txt"
log.write_text(f"SmolLM2-135M | wikitext (EN DOMAINE) | T={T} | W={W} | Lb={Lb} | m={M}\n",
               encoding="utf-8")
...
CFG.update({"sel": "rand", "seed": 1234}); run("rand_seed1234")
print("ok")
