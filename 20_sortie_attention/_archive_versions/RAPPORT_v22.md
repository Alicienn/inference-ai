...
*Version 22 — trois défauts corrigés, trois architectures, une loi quantitative, et une structure d'attention vérifiée*
...
`20_sortie_attention/code/` : `courbe_corrigee.py`, `remesure_qwen.py`, `echelle_corrigee.py`, `transfert_domaines.py`, `base_figee.py`, `index_appris_v2.py`, `audit_causal_base.py`, `balayage_Lb_m.py`, `balayage_budget_constant.py`, `balayage_fenetre.py`, `frontiere_budget.py`, `gpt2_generalite.py`, `echelle_saturee.py`, `mecanisme_trou.py`, `mecanisme_corrige.py`, `invariance_kappa.py`, `plancher_uniforme.py`, `decomposition_distante.py`, `sink_verif.py`, `grille_sink.py`, `verification_v2.py`, `verification_qwen.py`, `diag_verif.py`. Sorties dans `resultats/`.
